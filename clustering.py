...
class Clustering:
    ...
    def apply_kmeans_clustering(self, scaled_data, num_clusters=3):
        """
        ...
        try:
            ...
            logging.info(
                f"Silhouette Score for {num_clusters} clusters: {silhouette_avg}"
            )
            return clusters, kmeans
        except Exception as e:
            logging.error(f"An error occurred during K-Means clustering: {e}")
            return None, None

    def apply_pca(self, scaled_data, clusters):
        """
    ...
    def get_pca_loadings(self, pca, features):
        """
    ...
    def apply_tsne(self, scaled_data, clusters):
        """
    ...
    def tune_kmeans_clustering(self, scaled_data, max_clusters=10):
        """
        ...
        try:
            ...
            for num_clusters in cluster_range:
                clusters, kmeans_model = self.apply_kmeans_clustering(
                    scaled_data, num_clusters
                )
            ...
            plt.grid(True, linestyle="--", linewidth=0.5)
            plt.tight_layout()
            save_plot(fig, "silhouette_scores.png")
            plt.show()
            ...
            logging.error(f"An error occurred while tuning K-Means clustering: {e}")
